                ...
                $("#jqxgrid").jqxGrid(
                        {
                            ...
                            columns: [
                                ...
                                {text: 'Von', dataField: 'start', width: 190, cellsalign: 'center', cellsformat: 'dddd'}, // formating the date to a user friendly format
...
<script>
    ...
    <body class='default'>
        ...
        <div id='jqxWidget' style="font-size: 14px; font-family: sans-serif; width:1550px; margin:20px auto;">
            ...
            <br><br>
            Raum&uuml;bersicht <b>VORDERHAUS 109</b> <br>
        ...
        <?php /*
          ...
          $ch = curl_init();
          $source = "https://app.psycho.unibas.ch/raumbuchung/index/json/id/23";
